            ...
            <div className="relative w-full max-w-md bg-culinary-dark border border-gray-700 rounded-sm shadow-2xl p-8 animate-in fade-in zoom-in duration-200">
                ...
                <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-culinary-dark text-gray-400">Or continue with</span>
                    </div>
                </div>
                ...
                <button
                    ...
                    type="button"
                    className="w-full bg-white text-gray-900 border border-gray-300 font-bold py-3 rounded-sm hover:bg-gray-100 transition-colors flex items-center justify-center gap-2"
                >
